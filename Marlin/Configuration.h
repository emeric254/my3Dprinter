...
#define CUSTOM_MENDEL_NAME "MyPrinter"
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {107.9,107.9,107.9,150}

#define DEFAULT_MAX_FEEDRATE          {250, 250, 5, 25}    // (mm/sec)
#define DEFAULT_MAX_ACCELERATION      {250,250,30,1000}    // X, Y, Z, E maximum start speed for accelerated moves. E default values are good for Skeinforge 40+, for older versions raise them a lot.
